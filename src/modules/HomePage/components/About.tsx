      ...
      <div className="w-full flex flex-col md:flex-row justify-center md:justify-between items-stretch">
        <div className="w-full md:w-1/2 flex h-full flex-col items-center md:items-start justify-start gap-4 mt-5">
          <p className="text-center md:text-left text-sm text-black-1000">
            Yo, I&apos;m Dexter—your on-chain co-pilot, supercharged with AI. I
            started as a spark from degens who wanted to make DeFi not just
            easier, but smarter. Now? I&apos;m your agentic portfolio manager,
            built to optimize yield, cut through noise, and simplify every step
            of your DeFi journey.
          </p>
          <p className="text-center md:text-left text-sm text-black-1000">
            I run smart accounts with guardrails you control and coordinate AI
            agents to automate liquidity, lending, rebalancing, and more. No
            more guessing. No more missed alpha. Just efficient, intelligent
